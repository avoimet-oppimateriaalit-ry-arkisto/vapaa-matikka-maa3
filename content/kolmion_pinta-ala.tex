...
Todista, että 
\begin{alakohdat}
\alakohta{suunnikkaan pinta-ala voidaan laske kaavalla
\[A = ah \]}
\alakohta{kolmion pinta-ala voidaan laskea kaavalla
\[A = \frac{ah}{2} \]}
\end{alakohdat}
\begin{vastaus}
\begin{alakohdat}
\alakohta{[KUVA, jossa suunnikas jaettu korkeusjanoilla kolmeen osaan ja varjostettu siirrettävät alueet, you know, sellanen perus perustelu]}
\alakohta{Käytä a)-kohtaa. Mitä saat, kun jaat suunnikkaan kahteen osaan? Entä käänteisesti?}
\end{alakohdat}
\end{vastaus}
\end{tehtava}
